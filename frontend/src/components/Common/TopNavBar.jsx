...
const TopNavBar = () => {
	...
	return (
		<>
			<nav className='flex sticky left-0 right-0 top-0 z-50 justify-between p-2 bg-white rounded-es-sm rounded-ee-sm text-black shadow-lg' style={{ minWidth: '310px' }}>
				<div
					onClick={openDrawer}
